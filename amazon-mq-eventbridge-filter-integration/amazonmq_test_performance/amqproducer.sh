...
java -cp "target/demo-1.0-SNAPSHOT.jar:target/dependency-jars/*"  org.fusebyexample.activemq.SimpleProducer -b "ssl://b-109b32a7-4e0e-486c-b8e7-9d98eb67acbc-1.mq.us-east-1.amazonaws.com:61617" -u "admin" -p "R1tVAZI)znNv6fN<"
