...
accelerator = globalaccelerator.Accelerator(self, "Accelerator",
    ...
    ip_address_type=globalaccelerator.IpAddressType.IPV4
)
```
...
class AcceleratorAttributes:
    def __init__(
        ...
        *,
        ...
        :param dual_stack_dns_name: The DNS name that points to the dual-stack accelerator's four static IP addresses: two IPv4 addresses and two IPv6 addresses. Default: - undefined
        :param ipv4_addresses: The array of IPv4 addresses in the IP address set. Default: - undefined
        :param ipv6_addresses: The array of IPv6 addresses in the IP address set. Default: - undefined
        ...
        if __debug__:
            ...
            check_type(argname="argument dual_stack_dns_name", value=dual_stack_dns_name, expected_type=type_hints["dual_stack_dns_name"])
        ...
        if dual_stack_dns_name is not None:
            self._values["dual_stack_dns_name"] = dual_stack_dns_name
    ...
    @builtins.property
    def dual_stack_dns_name(self) -> typing.Optional[builtins.str]:
        ...
        :default: - undefined
        '''
        result = self._values.get("dual_stack_dns_name")
...
class _IAcceleratorProxy(
    ...
    def dual_stack_dns_name(self) -> typing.Optional[builtins.str]:
        ...
        :attribute: true
        '''
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "dualStackDnsName"))
    ...
    def ipv4_addresses(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        :attribute: true
        '''
        return typing.cast(typing.Optional[typing.List[builtins.str]], jsii.get(self, "ipv4Addresses"))
