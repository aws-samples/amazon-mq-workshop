...
class CfnEnvironment(
    ...
    @builtins.property
    @jsii.member(jsii_name="attrCeleryExecutorQueue")
    def attr_celery_executor_queue(self) -> builtins.str:
        '''The queue ARN for the environment's `Celery Executor <https://docs.aws.amazon.com/https://airflow.apache.org/docs/apache-airflow/stable/core-concepts/executor/celery.html>`_ . Amazon MWAA uses a Celery Executor to distribute tasks across multiple workers. When you create an environment in a shared VPC, you must provide access to the Celery Executor queue from your VPC.

        :cloudformationAttribute: CeleryExecutorQueue
        '''
        return typing.cast(builtins.str, jsii.get(self, "attrCeleryExecutorQueue"))

    @builtins.property
    @jsii.member(jsii_name="attrDatabaseVpcEndpointService")
    def attr_database_vpc_endpoint_service(self) -> builtins.str:
        '''The VPC endpoint for the environment's Amazon RDS database.

        :cloudformationAttribute: DatabaseVpcEndpointService
        '''
        return typing.cast(builtins.str, jsii.get(self, "attrDatabaseVpcEndpointService"))
    ...
    @builtins.property
    @jsii.member(jsii_name="attrWebserverVpcEndpointService")
    def attr_webserver_vpc_endpoint_service(self) -> builtins.str:
        '''The VPC endpoint for the environment's web server.

        :cloudformationAttribute: WebserverVpcEndpointService
        '''
        return typing.cast(builtins.str, jsii.get(self, "attrWebserverVpcEndpointService"))
    ...
    def endpoint_management(self) -> typing.Optional[builtins.str]:
        ...
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "endpointManagement"))

    @endpoint_management.setter
    def endpoint_management(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
...
def _typecheckingstub__e4476ed787b8ff178cb6d755b6bfdd138a76cfef6627272fc1c40f20ade5978c(
    value: typing.Optional[builtins.str],
) -> None:
    """Type checking stubs"""
    pass
