...
class CodeCommitSourceActionProps(_CommonAwsActionProps_8b809bb6):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            ...
            check_type(argname="argument custom_event_rule", value=custom_event_rule, expected_type=type_hints["custom_event_rule"])
        ...
        if custom_event_rule is not None:
            self._values["custom_event_rule"] = custom_event_rule
    ...
    @builtins.property
    def custom_event_rule(self) -> typing.Optional["ICustomEventRule"]:
        ...
        '''
        result = self._values.get("custom_event_rule")
