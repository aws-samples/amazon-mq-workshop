...
class CfnCertificateAuthority(
    ...
    @jsii.data_type(
        jsii_type="aws-cdk-lib.aws_acmpca.CfnCertificateAuthority.CrlDistributionPointExtensionConfigurationProperty",
        jsii_struct_bases=[],
    ...
    class CrlDistributionPointExtensionConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__87e4527e3d866d92aae92baceefa252c01b4f216d928fa28f945fb560943173f)
    ...
    @jsii.data_type(
        ...
        jsii_struct_bases=[],
        name_mapping={"party_name": "partyName", "name_assigner": "nameAssigner"},
    )
    class EdiPartyNameProperty:
        def __init__(
            self,
...
def _typecheckingstub__87e4527e3d866d92aae92baceefa252c01b4f216d928fa28f945fb560943173f(
    *,
    omit_extension: typing.Union[builtins.bool, _IResolvable_da3f097b],
) -> None:
    """Type checking stubs"""
