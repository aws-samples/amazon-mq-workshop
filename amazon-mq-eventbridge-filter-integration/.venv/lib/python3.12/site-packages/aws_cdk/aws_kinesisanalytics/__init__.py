...
class CfnApplicationV2(
    ...
    @jsii.data_type(
        jsii_type="aws-cdk-lib.aws_kinesisanalytics.CfnApplicationV2.ApplicationSystemRollbackConfigurationProperty",
        jsii_struct_bases=[],
        ...
        def __init__(
            ...
            *,
            ...
            Example::
                ...
                application_system_rollback_configuration_property = kinesisanalytics.CfnApplicationV2.ApplicationSystemRollbackConfigurationProperty(
                    rollback_enabled=False
                )
            '''
            if __debug__:
