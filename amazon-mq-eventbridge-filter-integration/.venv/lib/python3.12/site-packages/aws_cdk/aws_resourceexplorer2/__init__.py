...
class CfnView(
    ...
    @jsii.data_type(
        jsii_type="aws-cdk-lib.aws_resourceexplorer2.CfnView.SearchFilterProperty",
        jsii_struct_bases=[],
        name_mapping={"filter_string": "filterString"},
    )
    class SearchFilterProperty:
        def __init__(self, *, filter_string: builtins.str) -> None:
            ...
            Example::
                ...
                search_filter_property = resourceexplorer2.CfnView.SearchFilterProperty(
                    filter_string="filterString"
                )
            '''
            if __debug__:
...
def _typecheckingstub__6ce03d0317ddc3e528365ec97587f9be02a8e6694ea00dc083c89cfc737d8c78(
