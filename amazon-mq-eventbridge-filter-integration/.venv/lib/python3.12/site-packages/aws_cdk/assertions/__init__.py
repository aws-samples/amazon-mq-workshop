...
from aws_cdk.assertions import Tags
...
```python
# no tags present
Tags.from_stack(stack).has_none()
...
class Tags(metaclass=jsii.JSIIMeta, jsii_type="aws-cdk-lib.assertions.Tags"):
    ...
    def all(self) -> typing.Mapping[builtins.str, builtins.str]:
        ...
        '''
        return typing.cast(typing.Mapping[builtins.str, builtins.str], jsii.invoke(self, "all", []))

    @jsii.member(jsii_name="hasNone")
    def has_none(self) -> None:
        ...
        object.
        '''
        return typing.cast(None, jsii.invoke(self, "hasNone", []))

    @jsii.member(jsii_name="hasValues")
    def has_values(self, tags: typing.Any) -> None:
...
def _typecheckingstub__62e9347d457a951d50880cd16c1eee01eecf6d2b9875a6a7a907d3dd1d5de960(
    tags: typing.Any,
) -> None:
    """Type checking stubs"""
    pass
