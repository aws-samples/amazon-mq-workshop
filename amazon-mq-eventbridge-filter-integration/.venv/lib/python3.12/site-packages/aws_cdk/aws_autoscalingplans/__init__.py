...
class CfnScalingPlan(
    ...
    For more information, see the `Scaling Plans User Guide <https://docs.aws.amazon.com/autoscaling/plans/userguide/what-is-a-scaling-plan.html>`_
    ...
    class PredefinedLoadMetricSpecificationProperty:
        def __init__(
            ...
            *,
            ...
            '''``PredefinedLoadMetricSpecification`` is a subproperty of `ScalingInstruction <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-autoscalingplans-scalingplan-scalinginstruction.html>`_ that specifies a predefined load metric for predictive scaling to use with a scaling plan.
    ...
    class ScalingInstructionProperty:
        def __init__(
            ...
            *,
            ...
            :param disable_dynamic_scaling: Controls whether dynamic scaling is disabled. When dynamic scaling is enabled, AWS Auto Scaling creates target tracking scaling policies based on the specified target tracking configurations. The default is enabled ( ``false`` ).
            ...
            :param scaling_policy_update_behavior: Controls whether a resource's externally created scaling policies are deleted and new target tracking scaling policies created. The default value is ``KeepExternalPolicies`` . Valid only when configuring dynamic scaling.
    ...
    class TagFilterProperty:
        def __init__(
            ...
            *,
            ...
            '''``TagFilter`` is a subproperty of `ApplicationSource <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-autoscalingplans-scalingplan-applicationsource.html>`_ that specifies a tag for an application source to use with a scaling plan.
    ...
    class TargetTrackingConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''``TargetTrackingConfiguration`` is a subproperty of `ScalingInstruction <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-autoscalingplans-scalingplan-scalinginstruction.html>`_ that specifies a target tracking configuration for a scalable resource.
